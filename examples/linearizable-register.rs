    ...
    checker.assert_discovery(
        ...
        vec![
            ...
            Deliver {
                src: Id::from(1),
                dst: Id::from(0),
                msg: Internal(Query(3)),
            },
            Deliver {
                src: Id::from(0),
                dst: Id::from(1),
                msg: Internal(AckQuery(3, (0, Id::from(0)), '\u{0}')),
            },
            Deliver {
                src: Id::from(1),
                dst: Id::from(0),
                msg: Internal(Record(3, (1, Id::from(1)), 'B')),
            },
            Deliver {
                src: Id::from(0),
                dst: Id::from(1),
                msg: Internal(AckRecord(3)),
            },
            Deliver {
                src: Id::from(1),
                dst: Id::from(3),
            ...
            Deliver {
                src: Id::from(0),
                dst: Id::from(1),
                msg: Internal(Query(6)),
            },
            Deliver {
                src: Id::from(1),
                dst: Id::from(0),
                msg: Internal(AckQuery(6, (1, Id::from(1)), 'B')),
            },
            Deliver {
                src: Id::from(0),
                dst: Id::from(1),
                msg: Internal(Record(6, (1, Id::from(1)), 'B')),
            },
            Deliver {
                src: Id::from(1),
                dst: Id::from(0),
                msg: Internal(AckRecord(6)),
            },
        ],
    );
